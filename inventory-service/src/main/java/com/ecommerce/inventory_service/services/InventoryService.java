...
import com.ecommerce.inventory_service.model.dtos.BaseResponse;
import com.ecommerce.inventory_service.model.dtos.OrderItemRequest;
import com.ecommerce.inventory_service.model.entities.Inventory;
    ...
    public BaseResponse areInStock(List<OrderItemRequest> orderItems) {
        ...
        orderItems.forEach(orderItem -> {
           ...
           if (inventory.isEmpty()){
               ...
               errorList.add("Product with sku " + orderItem.getSku() + " has insufficient quantify");
           }
        });
